...
import com.tierconnect.riot.controllers.ThingControllerTest;
import com.tierconnect.riot.utils.TestUtils;

public class ThingVisibilityTest {
	...
	/*Thing list with filter*/
	
	@Test
    public void testGetThing() {
		expectResponse(baseUri+"/1", 200,HTTPMethod.GET,null);
		expectResponse(baseUri+"/1", 200,HTTPMethod.GET,null,"adminc");
		expectResponse(baseUri+"/1", 200,HTTPMethod.GET,null,"adminf");
    }
	@Test
