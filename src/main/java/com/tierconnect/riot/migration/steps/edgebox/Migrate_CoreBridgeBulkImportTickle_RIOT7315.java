 ...
 * on 11/17/15.
 */
public class Migrate_CoreBridgeBulkImportTickle_RIOT7315 implements MigrationStep {
    private static Logger logger = Logger.getLogger(Migrate_CoreBridgeBulkImportTickle_RIOT7315.class);
