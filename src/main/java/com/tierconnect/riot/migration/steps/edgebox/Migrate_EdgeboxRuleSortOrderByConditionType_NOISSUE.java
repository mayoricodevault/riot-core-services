 ...
 */
public class Migrate_EdgeboxRuleSortOrderByConditionType_NOISSUE implements MigrationStep {
    ...
    public void migrateHibernate() throws Exception {
        ...
        for (Edgebox edgebox : edgeboxList) {
            ...
            for (ObjectNode groupParameter : conditionTypeGroups) {
                ...
                List<EdgeboxRule> edgeboxRulesList = EdgeboxRuleService.getInstance().listPaginated(be, pagination, "sortOrder:asc,conditionType:desc");
