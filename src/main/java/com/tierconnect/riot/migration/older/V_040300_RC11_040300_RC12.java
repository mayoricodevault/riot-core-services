 ...
 */
@Deprecated
public class V_040300_RC11_040300_RC12 implements MigrationStepOld {

    Logger logger = Logger.getLogger(V_040300_RC11_040300_RC12.class);

    @Override
    public List<Integer> getFromVersions() {
        return Collections.singletonList(4030011);
    }
    ...
    public void migrateSQLBefore() throws Exception {
        ...
        dbHelper.executeSQLFile("sql/" + databaseType + "/V040300_RC11_to_040300_RC12.sql");
    }
