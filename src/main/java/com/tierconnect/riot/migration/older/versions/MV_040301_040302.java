...
import com.tierconnect.riot.migration.older.V_040301_040302;
 ...
 */
@Deprecated
public class MV_040301_040302 extends MigrationVersionStepOld {
    private static Logger logger = Logger.getLogger(MV_040301_040302.class);
    int currentVersion = 40301;
    int targetVersion = 40302;
    int targetRelease = 40302;
    int dbVersion = 0;

    public MV_040301_040302() {
        fillMigrationSteps();
...
//    }
    ...
    public void fillMigrationSteps() {
        MigrationStepOld migrationStep = new V_040301_040302();
