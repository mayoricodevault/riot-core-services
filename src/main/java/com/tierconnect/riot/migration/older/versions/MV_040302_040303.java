...
import com.tierconnect.riot.migration.older.V_040302_040303;
 ...
 *
 * @author : rchirinos
 * @date : 10/27/16 3:45 PM
 * @version:
 */
@Deprecated
public class MV_040302_040303 extends MigrationVersionStepOld {

    private static Logger logger = Logger.getLogger(MV_040302_040303.class);
    int currentVersion = 40302;
    int targetVersion = 40303;
    int targetRelease = 40303;
    int dbVersion = 0;

    public MV_040302_040303() {
        fillMigrationSteps();
    ...
    public void fillMigrationSteps() {
        MigrationStepOld migrationStep = new V_040302_040303();
