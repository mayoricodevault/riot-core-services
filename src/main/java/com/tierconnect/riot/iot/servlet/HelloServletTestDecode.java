 ...
 */
@WebServlet("/testServletDecode")
public class HelloServletTestDecode extends HttpServlet {

    private static Logger logger = Logger.getLogger(HelloServletTestDecode.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getInputStream() != null) {
            ...
            logger.info(decode);
            logger.info("-------------------------------------------------");
            response.getWriter().println("<br />" + decode);
        }
    }
}
